...
const eventos = () =>{
    ...
    menuItems.forEach(item => {
        item.addEventListener('click', () => {
            cerrarMenu();
            // Agrega aquí la funcionalidad específica para cada elemento del menú
            // Por ejemplo:
            // if (item.textContent === 'Inicio') {
            //     // Hacer algo cuando se hace clic en "Inicio"
            // } else if (item.textContent === 'Sobre nosotros') {
            //     // Hacer algo cuando se hace clic en "Sobre nosotros"
            // }
        });
    });
};
